...
class DbDialectTest extends PHPUnit_Framework_TestCase
{
	...
	public function testMssqlDialect(){
		$dialect = new \Twm\Db\Dialect\Mssql();
		...
		//Column definitions
		$this->assertEquals($dialect->getColumnDefinition($columns['column1']), 'NCHAR(10)');
		...
		$this->assertEquals($dialect->getColumnDefinition($columns['column8']), 'NUMERIC(10,2)');

		//Add Columns
		$this->assertEquals($dialect->addColumn('table', null, $columns['column1']), 'ALTER TABLE [table] ADD [column1] NCHAR(10)');
		$this->assertEquals($dialect->addColumn('table', 'schema', $columns['column1']), 'ALTER TABLE [schema].[table] ADD [column1] NCHAR(10)');
		$this->assertEquals($dialect->addColumn('table', null, $columns['column2']), 'ALTER TABLE [table] ADD [column2] INT');
		$this->assertEquals($dialect->addColumn('table', 'schema', $columns['column2']), 'ALTER TABLE [schema].[table] ADD [column2] INT');
		$this->assertEquals($dialect->addColumn('table', null, $columns['column3']), 'ALTER TABLE [table] ADD [column3] DECIMAL(10,2)');		//NOT NULL  alter with not ll is not allowed in mssql 
		$this->assertEquals($dialect->addColumn('table', 'schema', $columns['column3']), 'ALTER TABLE [schema].[table] ADD [column3] DECIMAL(10,2)');
		$this->assertEquals($dialect->addColumn('table', null, $columns['column4']), 'ALTER TABLE [table] ADD [column4] CHAR(100)');
		$this->assertEquals($dialect->addColumn('table', 'schema', $columns['column4']), 'ALTER TABLE [schema].[table] ADD [column4] CHAR(100)');
		$this->assertEquals($dialect->addColumn('table', null, $columns['column5']), 'ALTER TABLE [table] ADD [column5] DATE');
		$this->assertEquals($dialect->addColumn('table', 'schema', $columns['column5']), 'ALTER TABLE [schema].[table] ADD [column5] DATE');
		$this->assertEquals($dialect->addColumn('table', null, $columns['column6']), 'ALTER TABLE [table] ADD [column6] DATETIME');
		$this->assertEquals($dialect->addColumn('table', 'schema', $columns['column6']), 'ALTER TABLE [schema].[table] ADD [column6] DATETIME');
		$this->assertEquals($dialect->addColumn('table', null, $columns['column7']), 'ALTER TABLE [table] ADD [column7] TEXT');
		$this->assertEquals($dialect->addColumn('table', 'schema', $columns['column7']), 'ALTER TABLE [schema].[table] ADD [column7] TEXT');
		$this->assertEquals($dialect->addColumn('table', null, $columns['column8']), 'ALTER TABLE [table] ADD [column8] NUMERIC(10,2)');
		$this->assertEquals($dialect->addColumn('table', 'schema', $columns['column8']), 'ALTER TABLE [schema].[table] ADD [column8] NUMERIC(10,2)');

		//Modify Columns
		$this->assertEquals($dialect->modifyColumn('table', null, $columns['column1']), 'ALTER TABLE [table] ALTER COLUMN [column1] NCHAR(10)');
		$this->assertEquals($dialect->modifyColumn('table', 'schema', $columns['column1']), 'ALTER TABLE [schema].[table] ALTER COLUMN [column1] NCHAR(10)');
		$this->assertEquals($dialect->modifyColumn('table', null, $columns['column2']), 'ALTER TABLE [table] ALTER COLUMN [column2] INT');
		$this->assertEquals($dialect->modifyColumn('table', 'schema', $columns['column2']), 'ALTER TABLE [schema].[table] ALTER COLUMN [column2] INT');
		$this->assertEquals($dialect->modifyColumn('table', null, $columns['column3']), 'ALTER TABLE [table] ALTER COLUMN [column3] DECIMAL(10,2)');
		$this->assertEquals($dialect->modifyColumn('table', 'schema', $columns['column3']), 'ALTER TABLE [schema].[table] ALTER COLUMN [column3] DECIMAL(10,2)');
		$this->assertEquals($dialect->modifyColumn('table', null, $columns['column4']), 'ALTER TABLE [table] ALTER COLUMN [column4] CHAR(100)');
		$this->assertEquals($dialect->modifyColumn('table', 'schema', $columns['column4']), 'ALTER TABLE [schema].[table] ALTER COLUMN [column4] CHAR(100)');
		$this->assertEquals($dialect->modifyColumn('table', null, $columns['column5']), 'ALTER TABLE [table] ALTER COLUMN [column5] DATE');
		$this->assertEquals($dialect->modifyColumn('table', 'schema', $columns['column5']), 'ALTER TABLE [schema].[table] ALTER COLUMN [column5] DATE');
		$this->assertEquals($dialect->modifyColumn('table', null, $columns['column6']), 'ALTER TABLE [table] ALTER COLUMN [column6] DATETIME');
		$this->assertEquals($dialect->modifyColumn('table', 'schema', $columns['column6']), 'ALTER TABLE [schema].[table] ALTER COLUMN [column6] DATETIME');
		$this->assertEquals($dialect->modifyColumn('table', null, $columns['column7']), 'ALTER TABLE [table] ALTER COLUMN [column7] TEXT');
		$this->assertEquals($dialect->modifyColumn('table', 'schema', $columns['column7']), 'ALTER TABLE [schema].[table] ALTER COLUMN [column7] TEXT');
		$this->assertEquals($dialect->modifyColumn('table', null, $columns['column8']), 'ALTER TABLE [table] ALTER COLUMN [column8] NUMERIC(10,2)');
		$this->assertEquals($dialect->modifyColumn('table', 'schema', $columns['column8']), 'ALTER TABLE [schema].[table] ALTER COLUMN [column8] NUMERIC(10,2)');
...
*/
	...
	public function testMysqlDialect1()
	{
	...
	public function testViews()
	{
		...
		$this->assertEquals($dialect->dropView('test_view', null, true), 'IF EXISTS (SELECT TABLE_NAME FROM INFORMATION_SCHEMA.VIEWS WHERE TABLE_NAME = \'test_view\') DROP VIEW test_view');
		$this->assertEquals($dialect->dropView('test_view', 'schema', false), 'DROP VIEW schema.test_view');
		$this->assertEquals($dialect->dropView('test_view', 'schema', true), "IF EXISTS (SELECT TABLE_NAME FROM INFORMATION_SCHEMA.VIEWS WHERE TABLE_NAME = 'test_view' AND TABLE_SCHEMA = 'schema') DROP VIEW schema.test_view");
